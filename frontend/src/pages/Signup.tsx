    ...
    <div className="min-h-screen bg-sky-gradient flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[var(--gray-800)]">Create your workspace</h1>
          <p className="text-[var(--gray-500)] text-sm mt-1.5">Launch your AI telecaller in minutes</p>
        </div>

        <div className="glass rounded-[var(--radius-lg)] shadow-[var(--shadow-lg)] p-7">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[13px] font-medium text-[var(--gray-700)] mb-1.5">Full Name</label>
            ...
            <div>
              <label className="block text-[13px] font-medium text-[var(--gray-700)] mb-1.5">
                Company <span className="text-[var(--gray-400)] font-normal">(optional)</span>
              </label>
              <div className="relative">
